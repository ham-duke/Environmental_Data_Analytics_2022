...
getwd()
setwd("/Users/Dell Laptop/Documents/GitHub/EDA/Data/Processed")
library(tidyverse)
...
PeterPaul.chem.nutrients.gathered <-
  read.csv("NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv", stringsAsFactors = TRUE)
EPAair <- read.csv("EPAair_O3_PM25_NC2021_Processed.csv", stringsAsFactors = TRUE)
...
print(Nutrientplot3)
class(PeterPaul.chem.nutrients.gathered$lakename)
