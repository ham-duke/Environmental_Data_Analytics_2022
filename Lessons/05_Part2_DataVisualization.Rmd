...
PeterPaul.chem.nutrients <- 
  read.csv("NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv")
PeterPaul.chem.nutrients.gathered <-
  read.csv("NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv")
EPAair <- read.csv("EPAair_O3_PM25_NC2021_Processed.csv")
...
NvsP2 <-
  ...
  xlab("TP mg/L") + # change your legend labels here
...
# place your additional edits here
  ...
  theme(legend.position = "right")+
  scale_fill_discrete(name="Nutrient Legend",
