...
```{r}
hightemp <- c(42, 45, 48, 35, 43, 52, 51, 60, 66, 59)

lowtemp <- c(20, 27, 27, 15, 26, 25, 33, 49, 48, 27)
...
hightempC <- F_to_C(hightemp)
lowtempC <- F_to_C(lowtemp)

#conversion F to C =  (x - 32)*5/9 
...
```{r}
df <- cbind(hightemp, lowtemp, hightempC, lowtempC)
