...
nutrient_data <- read_csv("/Users/Dell Laptop/Documents/GitHub/EDA/Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaul_Processed.csv")
...
ui <- fluidPage(theme = shinytheme("yeti"),
  # Choose a title
  titlePanel("Peter Lake and Paul Lake Nutrients"),
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput(inputId = "x",
                  ...
                  value = c(as.Date("1995-01-01"), as.Date("2004-12-31")))),
