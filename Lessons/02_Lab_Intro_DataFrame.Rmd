...
#echo = True all r chunks printed when knitted
#here you manually load packages too, library()
```
...
When we import data to R, a data frame is the preferred way for storing the data because columns can have different modes (character, numeric, integer, logical, complex).
...
Is the new object you created a data frame?
```{r}
#Option 1
class(car_speed)
