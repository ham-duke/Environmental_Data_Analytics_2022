...
PM2.5byOzone.regression <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(PM2.5byOzone.regression)

#R-squared = 0.1316, ozone explains 13% of the variability of PM2.5
#therefore need more variables for better explanation more explanatory variables needed 

#Exercise 4: Build a scatterplot. Add a line and standard error for the linear regression. 

PM2.5byOzone.Plot <- ggplot(EPAair, aes(x = Ozone, y = PM2.5))+
  geom_point()+ 
...
OzoneAll.regression <- lm(data = EPAair.subset, PM.5 ~ Ozone +
                            Year + Month + meanLng + mean Lat)
...
# new R squared = .192 19% explained now 
