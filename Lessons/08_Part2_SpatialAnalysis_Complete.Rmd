...
mapview(huc8_sf, col.regions = "orange")+
  mapview(huc8_sf.subset, col.regions = "purple")
...
This is a link to a spatial dataset in GeoJSON format. Now let's read this dataset in and explore it:
